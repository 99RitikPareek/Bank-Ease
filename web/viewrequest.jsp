...
<%@page import="java.sql.Connection"%>
 ...
 <%
     ...
     PreparedStatement st=connection.prepareStatement("select *from Request"); 
  ...
  %>
     ...
     <form action="requeststatus.jsp">
     <table width="70%" align="right" style="margin:50px; border:solid; border-color:white">
             <tr style="color:white" align="center">
                 <td>UPDATE STATUS</td>
                 <td><input type="text"name="acc" placeholder="enter account no" class="texttheme">
             <input type="text" name="status"placeholder="enter request status" class="texttheme">
